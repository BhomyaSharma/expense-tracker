...
function CreateBudget({ refreshData, userBudgetCount }) {
    ...
    return (
        <div>
            ...
            {/* Upgrade Alert */}
            {showUpgradeAlert && (
                <Dialog open={showUpgradeAlert}>
                    <DialogContent className="bg-white border border-pink-300 p-5 rounded-md shadow-lg shadow-pink-200 sm:max-w-[400px]">
                        <DialogHeader>
                            <DialogTitle className="text-pink-600 font-semibold">Upgrade Your Plan</DialogTitle>
                            <DialogDescription>
                                <div className='mt-5 text-center'>
                                    <h2 className="text-pink-500">You have reached the limit of 4 budgets.</h2>
                                    <p className="mt-3">To create more budgets, please upgrade your plan.</p>
                                    <Button
                                        className="bg-pink-500 text-white mt-5"
                                        onClick={() => window.location.href = "./upgrade"}  // Link to upgrade page
                                    >
                                        Upgrade Now
                                    </Button>
                                </div>
